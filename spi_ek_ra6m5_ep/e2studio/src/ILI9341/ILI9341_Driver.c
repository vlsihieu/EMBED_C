...
// /* Configuration of individual dummy pins. */
// static const ioport_pin_cfg_t g_dummy_pin_cfg_data[] =
// {
//     {
//         /* LCD chip-select pin. */
//         .pin = SSLA3_C_Pin,
...
// /* Dummy IOPORT pin configuration. */
// static const ioport_cfg_t g_dummy_pin_cfg =
// {
//     .number_of_pins = (uint16_t) (sizeof(g_dummy_pin_cfg_data) /
//                                   sizeof(g_dummy_pin_cfg_data[0])),

//     .p_pin_cfg_data = g_dummy_pin_cfg_data,
//     .p_extend       = NULL
// };
...
/**
 * @brief Initializes the LCD control pins and FSP SPI instance.
 *
 * @note If the SPI instance is already open, the existing instance
 *       remains active and the function continues normally.
 *
 * @retval FSP_SUCCESS Initialization completed successfully.
 * @return FSP error code returned by the IOPORT or SPI driver.
 */
...
fsp_err_t ILI9341_Init(void)
{
    ...
    /* Initialize the SPI and IOPORT modules. */
 ...
 * @retval FSP_ERR_ABORTED SPI transmission failed.
 * @return Any other FSP error code returned by the IOPORT or SPI driver.
 */
