...
/*******************************************************************************************************************//**
 * @file ILI9341_Gfx.c
 * @brief Implements graphics drawing functions for the ILI9341 LCD driver.
 *
 * This file provides functions for drawing circles, rectangles, characters, text, and full-screen RGB565 images
 * on an ILI9341 display connected to a Renesas RA microcontroller.
 **********************************************************************************************************************/
