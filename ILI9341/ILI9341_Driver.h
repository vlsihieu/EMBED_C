 ...
 * @brief Declares macros and APIs for controlling the ILI9341 TFT LCD using Renesas FSP SPI and IOPORT interfaces.
 *
 * This file defines the display dimensions, LCD control pins, RGB565 color values, supported screen orientations,
 * and public driver APIs for an ILI9341 display connected to a Renesas RA microcontroller.
 **********************************************************************************************************************/
...
/* SPI transmission buffer size in bytes. */
